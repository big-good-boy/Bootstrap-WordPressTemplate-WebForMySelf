...
function bluerex_widgets_init() {
	register_sidebar(
		array(
			'name'          => esc_html__( 'Footet Left', 'bluerex' ),
			'id'            => 'sidebar-footer1',
	...
	register_sidebar(
		array(
			'name'          => esc_html__( 'Footet Right', 'bluerex' ),
			'id'            => 'sidebar-footer2',
			'description'   => esc_html__( 'Add widgets here.', 'bluerex' ),
...
function bluerex_scripts() {
	...
	wp_enqueue_style( 'bluerex-bootstrap-css', 'https://cdn.jsdelivr.net/npm/bootstrap@5.0.0-beta1/dist/css/bootstrap.min.css' );
	wp_enqueue_style( 'bluerex-fontawesome-css', 'https://use.fontawesome.com/releases/v5.7.1/css/all.css' );
	wp_enqueue_style( 'bluerex-googlefonts', 'https://fonts.googleapis.com/css2?family=Montserrat:wght@300;400;600;700&family=Poppins:wght@300;400;600;700&display=swap' );
	...
	wp_enqueue_script( 'bluerex-popper-js', 'https://unpkg.com/@popperjs/core@2' );
	wp_enqueue_script( 'bluerex-bootstrap-js', 'https://cdn.jsdelivr.net/npm/bootstrap@5.0.0-beta1/dist/js/bootstrap.bundle.min.js' );
	wp_enqueue_script( 'bluerex-baguetteBox-js', get_template_directory_uri() . '/assets/js/baguetteBox.min.js' );
	wp_enqueue_script( 'bluerex-main-js', get_template_directory_uri() . '/assets/js/main.js' );
